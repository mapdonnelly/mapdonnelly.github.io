...
geometry: margin=1in
github: mapdonnelly
jobtitle: PhD Epidemiology (expected 2019), UC Davis
linkcolor: blue
orcid: null
fontawesome: yes
phone: 
...
<center> <h3>
__Marisa A.P. Donnelly__ 
</h4></center>
<center> <h4>
`r fa("envelope-open", fill = "steelblue")` madonnelly@ucdavis.edu | `r fa("github", fill = "steelblue")` [mapdonnelly](https://github.com/mapdonnelly) 
</h4></center>

***
#####SUMMARY OF PROFESSIONAL EXPERIENCE
Marisa Donnelly is a research epidemiologist with 6 years of experience in public health research, focusing particularly on vector-borne diseases and health equity. Marisa has extensive experience investigating arbovirus transmission dynamics, specializing in conducting field work and building statistical and mathematical models to indentify vulnerable communities for arboviral transmission. She is highly skilled in developing spatio-temporal statistical and mechanistic models, survey design, mobile data collection, and fieldwork, and has substantial knowledge of mathematical modeling, geographic information systems (GISs), mosquito rearing, and laboratory work.  

***  

##### EDUCATION

*University of California, Davis*, Ph.D. Epidemiology \hfill (expected 2019)  
...
**Donnelly, M.P.**, S. Kluh, C.M. Barker, Quantifying socioeconomic heterogeneities in the risk of local Zika and dengue outbreaks in California. *Proceedings and Papers of the Mosquito and Vector Control Association of California* 87 (2018) 

**Donnelly, M.P.**, M. Marcantonio, F. Melton, C.M. Barker, Mapping past, present, and future climatic suitability for invasive Aedes aegypti in the United States: a process-based modeling approach. *Proceedings and Papers of the Mosquito and Vector Control Association of California* 86 (2017) 

**Donnelly, M.P.**, M. Marcantonio, F. Melton, C.M. Barker, Mapping climatic suitability for invasive Aedes aegypti and Aedes albopictus in the United States: a process-based modeling approach. *Proceedings and Papers of the Mosquito and Vector Control Association of California* 85 (2016) 

Simpson, J.K., **M.P. Donnelly**, M. Marcantonio, C.M. Barker, CalSurv Gateway: survey results and new tools for invasive Aedes, *Proceedings and Papers of the Mosquito and Vector Control Association of California* 84 (2016)  
...
##### GRANTS & AWARDS
- **($8,500)** University of California Global Health Institute, Planetary Health Center of Expertise Summer fellowship (Statewide competition) \hfill 2018
